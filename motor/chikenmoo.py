...
def main():
    ...
    try:
        ...
        print("  M1 f/b [steps] [accel] [speed <deg/s>|rpm <value>] [gamma <shape>] [pid? Kp Ki Kd]  -> motor1")
        print("  M2 f/b [steps] [accel] [speed <deg/s>|rpm <value>] [gamma <shape>] [pid? Kp Ki Kd]  -> motor2")
        print("  q                                    -> quit")
