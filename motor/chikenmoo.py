...
def main():
    ...
    try:
        ...
        print("  M1 f/b [steps] [accel] [speed <deg/s>|rpm <value>] [pid? Kp Ki Kd]  -> motor1")
        print("  M2 f/b [steps] [accel] [speed <deg/s>|rpm <value>] [pid? Kp Ki Kd]  -> motor2")
        print("  q                                    -> quit")
        ...
        while True:
            ...
            print(f"[{name}] steps={steps}, accel_ratio={accel_ratio}, direction={direction}, PID={use_pid} gains={pid_gains if use_pid else '-'}{speed_info}")
