            ...
            def parse_motion_args(motor_name):
                ...
                while idx < len(cmd):
                    ...
                    if token == 'pid':
                        ...
                        idx += 1
                return direction, steps, accel_ratio, s_curve_gamma, decel_ratio, s_curve_gamma_decel
